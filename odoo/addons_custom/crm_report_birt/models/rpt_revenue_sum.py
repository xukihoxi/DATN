...
class RptRevenueAllocationSumDefaultUse(models.TransientModel):
    _name = 'rpt.revenue.allocation.sum.default.use'
    ...
    def create_report(self):
        ...
        report_name = "rpt_revenue_sum_employee.rptdesign"
